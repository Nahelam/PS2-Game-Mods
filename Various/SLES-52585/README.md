# PCSX2 Burnout 3: Takedown Mods (SLES-52585)
...
- Show distance between you and other drivers in races (use **_ws** file if you're using PCSX2 widescreen patches) [\[demo\]](https://i.imgur.com/qws0uEH.mp4)
- Disable traffic
